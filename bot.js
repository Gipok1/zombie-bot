...
async function updateServerStatusMessage() {
    ...
    try {
        ...
        const response = `>>> **Serwer CS 1.6 Status**\n`
                         ...
                         + `***_Ostatnia aktualizacja:*** ${new Date().toLocaleTimeString('pl-PL', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false, timeZone: 'Europe/Warsaw' })}`; // Zmieniono format czasu!
